...
- `Advanced_Modem_others.asp` / `Advanced_Printer_others.asp` (Merlin shell with legacy compatibility skin, original USB modem/printer controls retained)
- `Shadowsocks.asp` / `Shadowsocks_log.asp` / `dns-forwarder.asp` / `mentohust.asp` / `mentohust_log.asp` / `scutclient.asp` / `scutclient_log.asp` (Merlin shell with legacy compatibility skin, original service controls, logs, and action forms retained)
