...
function showVSList(){
	...
	if(VSList.length == 0)
		...
		code += '<td><button class="remove_btn" type="submit" onclick="markGroupVS(this, 64,\' Del \');" name="VSList" title="<#CTL_del#>"></button></td>';
		code += '</tr>'
	}
                                ...
                                <tr>
                                    <td bgcolor="#4D595D" valign="top">
                                        ...
                                        <tr id="row_famous_game">
                                            ...
                                            <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable table-list" id="VSList_Block" style="margin-top:10px;">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="add_btn" type="submit" onclick="return markGroupVS(this, 64, ' Add ');" name="VSList2" title="<#CTL_add#>"></button>
                                            </td>
                                        </tr>
                                    </table>
