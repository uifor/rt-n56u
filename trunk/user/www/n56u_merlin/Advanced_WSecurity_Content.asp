                            ...
                            <tbody>
                                <tr>
                                    <td bgcolor="#4D595D" valign="top">
                                        <div class="container">
                                            <div>&nbsp;</div>
                                            <div class="formfonttitle"><#menu5_1#> - <#t2RADIUS#> (5GHz)</div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <button class="password_toggle" type="button" onclick="passwordShowHide('wl_radius_key')">...</button>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <div class="apply_gen">
                                                <input class="button_gen" type="button" value="<#GO_2G#>" onclick="location.href='Advanced_WSecurity2g_Content.asp';">
