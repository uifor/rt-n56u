                                ...
                                <tr>
                                    <td bgcolor="#4D595D" valign="top">
                                        <div class="container">
                                            ...
                                            <div id="router_in_pool" class="alert alert-danger" style="display:none;"><b><#LANHostConfig_DHCPServerConfigurable_sectiondesc2#> <span id="LANIP"></span></b></div>

                                            <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable dhcp_section">
                                        <tr id="row_dhcpd_rt">
