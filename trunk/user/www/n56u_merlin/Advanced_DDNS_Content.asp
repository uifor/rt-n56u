                                ...
                                <tr>
                                    <td bgcolor="#4D595D" valign="top">
                                        <div class="container">
                                            ...
                                            <div id="wan_ip_hide2" class="alert alert-danger" style="display:none;"><#LANHostConfig_x_DDNSEnable_sectiondesc2#></div>
                                            <div id="wan_ip_hide3" class="alert alert-danger" style="display:none;"><#LANHostConfig_x_DDNSEnable_sectiondesc3#></div>

                                            <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable ddns_section">
                                        <tr>
                                    ...
                                    <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable ddns_section" id="tbl_ddns2" style="display:none;">
                                        <tr>
                                    ...
                                    <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable ddns_section" id="tbl_common" style="display:none;">
                                        <tr>
