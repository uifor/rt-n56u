							...
							<tbody>
								<tr>
									<td bgcolor="#4D595D" valign="top">
	                                    ...
	                                    <div class="alert alert-info"><#Setting_save_upload_desc#></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
	                                            ...
	                                            <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="tbl_rwfs" style="display:none; margin-top:10px;">
                                        <tr>
