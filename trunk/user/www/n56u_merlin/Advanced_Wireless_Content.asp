                                ...
                                <tbody>
                                    <tr>
                                        <td bgcolor="#4D595D" valign="top">
                                            <div class="container">
                                                <div>&nbsp;</div>
                                                <div class="formfonttitle"><#menu5_1#> - <#menu5_1_1#> (5GHz)</div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="apply_gen">
                                                    <input type="button" class="button_gen" value="<#GO_2G#>" onclick="location.href='Advanced_Wireless2g_Content.asp';">
