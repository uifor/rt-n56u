...
function showGWStaticList(){
	...
	if(GWStaticList.length == 0)
		...
		code += '<td><button class="remove_btn" type="submit" onclick="GWStatic_markGroup(this, 64,\' Del \');" name="GWStatic" title="<#CTL_del#>"></button></td>';
		code += '</tr>'
	}
                                ...
                                <tr>
                                    <td bgcolor="#4D595D" valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable table-list" id="GWStaticList_Block" style="margin-top:10px;">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="add_btn" type="submit" onClick="return GWStatic_markGroup(this, 64, ' Add ');" name="GWStatic2" title="<#CTL_add#>"></button>
                                            </td>
                                        </tr>
                                    </table>
