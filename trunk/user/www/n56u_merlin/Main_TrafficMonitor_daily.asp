...
function redraw_history(){
	...
	grid =  '<table class="FormTable traffic_history" width="100%" cellspacing="1" border="1" bordercolor="#6b8fa3">';
...
.traffic_history td {padding: 4px 8px;}
                                ...
                                <tbody>
                                    <tr>
                                        <td bgcolor="#4D595D" valign="top">
                                            <div class="container">
                                                <div>&nbsp;</div>
                                                <div id="bx_label" class="formfonttitle"><#menu4#></div>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="FormTable" border="1" bordercolor="#6b8fa3" style="margin-bottom: 0px;">
                                        <tr>
