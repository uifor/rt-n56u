...
function showLWFilterList(){
	...
	if(LWFilterList.length == 0)
		...
		code += '<td><button class="remove_btn" type="submit" onclick="markGroupLWF(this,64,\' Del \');" name="LWFilterList" title="<#CTL_del#>"></button></td>';
		code += '</tr>'
	}
...
function changeBgColor(obj, num){
	$("row" + num).style.background=(obj.checked)?'#596E74':'#475A5F';
}
                                ...
                                <tr>
                                    <td bgcolor="#4D595D" valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="tbl_lwf_main" style="display:none; margin-top:10px;">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable table-list" id="LWFilterList_Block" style="display:none; margin-top:10px;">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="add_btn" type="submit" onclick="return markGroupLWF(this, 64, ' Add ');" name="LWFilterList2" title="<#CTL_add#>"></button>
                                            </td>
                                        </tr>
                                            </table>
