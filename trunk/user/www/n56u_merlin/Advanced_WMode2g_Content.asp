                            ...
                            <tbody>
                                <tr>
                                    <td bgcolor="#4D595D" valign="top">
                                        <div class="container">
                                            <div>&nbsp;</div>
                                            <div class="formfonttitle"><#menu5_1#> - <#menu5_1_3#> (2.4GHz)</div>
                                    ...
                                    <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" style="margin-top:10px;">
                                        <tr id="row_wds_apc" style="display:none;">
                                            ...
                                            <td>
                                                ...
                                                <input class="wmode_button" id="RBRList" style="margin-left: 5px; width: 99px;" type="submit" onClick="return markGroup(this, 'rt_RBRList', 4, ' Add ');" name="rt_RBRList" value="<#CTL_add#>" size="12">
                                        ...
                                        <tr id="row_wds_2" style="display:none;">
                                            ...
                                            <td>
                                                <div style="float: left;">
                                                    ...
                                                    <input class="wmode_button wmode_delete" style="width: 99px;" type="submit" onClick="return markGroup(this, 'rt_RBRList', 2, ' Del ');" name="rt_RBRList2" value="<#CTL_del#>" size="12">
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="row_apc_3" style="display:none;">
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <button class="wmode_button" style="margin-left: -5px;" type="button" onclick="passwordShowHide('rt_sta_wpa_psk')">...</button>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <div class="apply_gen">
                                                <input class="button_gen" type="button" name="goto5" value="<#GO_5G#>" onclick="location.href='Advanced_WMode_Content.asp';">
