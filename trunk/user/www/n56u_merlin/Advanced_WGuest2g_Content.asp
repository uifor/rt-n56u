                            ...
                            <tbody>
                                <tr>
                                    <td bgcolor="#4D595D" valign="top">
                                        <div class="container">
                                            <div>&nbsp;</div>
                                            <div class="formfonttitle"><#menu5_1#> - <#menu5_1_2#> (2.4GHz)</div>
                                    ...
                                    <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                                        ...
                                        <tr id="row_guest_12" style="display:none;">
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <button class="guest_button" style="margin-left: -5px;" type="button" onclick="passwordShowHide('rt_guest_wpa_psk')">...</button>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="row_guest_13" style="display:none;">
                                            ...
                                            <div class="apply_gen">
                                                <input type="button" class="button_gen" name="goto5" value="<#GO_5G#>" onclick="location.href='Advanced_WGuest_Content.asp';">
